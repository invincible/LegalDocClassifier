...
def upload_files(file_path):
    ...
    with zipfile.ZipFile("uploaded_files/dogovor.zip", "a", compression=zipfile.ZIP_DEFLATED) as zipf:
        destination = file_path.split("/")[1]
        zipf.write(file_path, destination)
